                ...
                <div class="content-side content-side-full">
                    <ul class="nav-main">
                        @if (auth()->user()->role == 'admin' || auth()->user()->role == 'supervisor')
                            ...
                            <li class="nav-main-item ">
                                <a class="nav-main-link {{ Route::is('karyawan') ? 'active' : '' }}"
                                    href="{{ route('karyawan') }}">
                            ...
                            <li class="nav-main-item">
                                <a class="nav-main-link {{ Route::is('mesin') ? 'active' : '' }}"
                                    href="{{ route('mesin') }}">
                            ...
                            <li class="nav-main-item">
                                <a class="nav-main-link {{ Route::is('customer') ? 'active' : '' }}"
                                    href="{{ route('customer') }}">
                            ...
                            <li class="nav-main-item">
                                <a class="nav-main-link {{ Route::is('kontrak') ? 'active' : '' }}"
                                    href="{{ route('kontrak') }}">
                            ...
                            <li class="nav-main-item">
                                <a class="nav-main-link {{ Route::is('cuti') ? 'active' : '' }}"
                                    href="{{ route('cuti') }}">
                        ...
                        @if (auth()->user()->role == 'admin' || auth()->user()->role == 'supervisor')
                            <li class="nav-main-item">
                                <a class="nav-main-link {{ Route::is('absensi') ? 'active' : '' }}"
                                    href="{{ route('absensi') }}">
                            ...
                            <li class="nav-main-item">
                                <a class="nav-main-link {{ Route::is('absensi_ketidakhadiran') ? 'active' : '' }}"
                                    href="{{ route('absensi_ketidakhadiran') }}">
                                    <i class="nav-main-link-icon fa fa-calendar-xmark"></i>
                                    <span class="nav-main-link-name">Ketidakhadiran</span>
                                </a>
                            </li>
                            <li class="nav-main-item">
                                <a class="nav-main-link {{ Route::is('periode') ? 'active' : '' }}"
                                    href="{{ route('periode') }}">
                        ...
                        @if (auth()->user()->role === 'admin')
                            ...
                            <li class="nav-main-item">
                                <a class="nav-main-link {{ Route::is('overhaul_list') ? 'active' : '' }}"
                                    href="{{ route('overhaul_list') }}">
                                    <i class="nav-main-link-icon fa fa-cash-register"></i>
                                    <span class="nav-main-link-name">List Mesin</span>
                                </a>
                            </li>
                            <li class="nav-main-item">
                                <a class="nav-main-link {{ Route::is('overhaul_proses') ? 'active' : '' }}"
                                    href="{{ route('overhaul_proses') }}">
                                    <i class="nav-main-link-icon fa fa-dumpster-fire"></i>
                                    <span class="nav-main-link-name">Proses Overhaul</span>
                                </a>
                            </li>
                            <li class="nav-main-item">
                                <a class="nav-main-link {{ Route::is('cekqr') ? 'active' : '' }}"
                                    href="{{ route('cekqr') }}">
                            ...
                            <li class="nav-main-item">
                                <a class="nav-main-link {{ Route::is('jadwal_spk') ? 'active' : '' }}"
                                    href="{{ route('jadwal_spk') }}">
                        ...
                        <li class="nav-main-item">
                            <a class="nav-main-link {{ Route::is('profil') ? 'active' : '' }}"
                                href="{{ route('profil') }}">
        ...
        <div class="content py-3">
            <div class="row fs-sm">
                <div class="col-sm-6 order-sm-2 py-1 text-center text-sm-end">
                    Develop by <a class="fw-semibold" href="https://solusiciptamedia.com" target="_blank">Solusi
                        Cipta Media</a>
                </div>
                <div class="col-sm-6 order-sm-1 py-1 text-center text-sm-start">
                    <a class="fw-semibold" href="#" target="_blank">CV. Cipta Multi Solution</a> &copy; <span
